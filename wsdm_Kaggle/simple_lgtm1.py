...
def writeToData (test_df):
    ...
    submit_df.to_csv(data_path + 'submission.csv', index=False, float_format='%.5f')
...
if __name__ == "__main__":
    ...
    X = pd.read_csv(data_path +'train.csv')
    ...
    threshold = 0.5
    test_df = prediction (overall_prob, all3_cat_prob, test_df, threshold )
